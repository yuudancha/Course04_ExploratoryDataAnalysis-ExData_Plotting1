# plot4.R -> A 2x2 array containing plot2.png and plot3.png, and two new ones looking at voltage
...
# 4. Create the plot; see spec above
# The key here is having a 2 x 2 array. I can reuse two of the previous plot code snippets
...
with(Feb2days, plot(Date_Time, Global_active_power, type="l", ylab="Global Active Power (kilowatts)"))

# second plot (new one)
with(Feb2days, plot(Date_Time, Voltage, type = "l", xlab="datetime", ylab="Voltage"))

# third plot (plot3.png)
with(Feb2days, plot(Date_Time, Sub_metering_1, type="l", ylab="Energy sub metering"))
...
# fourth plot (other new one)
with(Feb2days, plot(Date_Time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
