# plot1.R -> Simple Histogram of Global Active Power
...
# 4. Create the plot; see spec above / demo image online

png("plot1.png", width=480, height=480)
hist(Feb2days$Global_active_power, col="red", border="black", main ="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency")
dev.off()
